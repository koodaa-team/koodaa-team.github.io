(function (global, factory) {
  ...
  ***************************************************************************** */
  ...
  var FaceLandmarks = /** @class */ (function () {
      ...
      FaceLandmarks.prototype.getPointsForGlasses = function () {
          throw new Error('getPointsForGlasses not implemented by base class');
      };
  ...
  var FaceLandmarks68 = /** @class */ (function (_super) {
      ...
      FaceLandmarks68.prototype.getPointsForGlasses
          = function () {
          return this.getLeftEye().concat(this.getRightEye());
      };
  ...
  var DrawFaceLandmarks = /** @class */ (function () {
      ...
      DrawFaceLandmarks.prototype.draw = function (canvasArg) {
          ...
          if (drawPoints) {
              ...
              // for (i = 0; i < this.faceLandmarks.positions.length; i++) {
              //     const pt = this.faceLandmarks.positions[i];
              //     if (this.faceLandmarks.getLeftEyeBrow().includes(pt) || this.faceLandmarks.getRightEyeBrow().includes(pt) || this.faceLandmarks.getLeftEye().includes(pt) || this.faceLandmarks.getRightEye().includes(pt)) {
              //         ctx.beginPath();
              ...
              this.faceLandmarks.getPointsForGlasses().forEach(drawPoint);
